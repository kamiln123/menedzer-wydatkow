...
Sprint 1 został opublikowany jako release `v0.1.0`. Sprint 2 — formularz oraz tymczasowa lista wydatków — został ukończony i ręcznie przetestowany lokalnie. Przygotowujemy publikację wersji `v0.2.0`.
