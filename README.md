...
Sprint 5 — miesięczny budżet i podsumowanie wydatków — jest ukończony lokalnie oraz sprawdzony ręcznie. Następny krok to commit, tag `v0.5.0` i publikacja GitHub Release.
